const { GMAIL_ADDRESS, GMAIL_APP_PW } = require("../config");
    ...
    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
      <tr>
        <td style="padding:0 0 16px 0;">
          <h1 style="font-weight: 700;color:#000000;font-size:24px;margin:0 0 20px 0;font-family:sans-serif;">${mailOptions.templateH1} code: sll-ecommerce</h1>
